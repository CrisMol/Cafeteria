...
?>
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Pago Cr&eacute;dito</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Reversiones Pago Cr&eacute;dito <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Pagos Cr&eacute;ditos <span class="fw-300"><i>Hoy</i></span>
                  </h2>
...
<?php
    $contador = 0;
    $movimientos_profesor = conseguir_movimientos_profesor($db, $codigoProfesor = null, 1, $fechaInforme);
...
?>
    <tr>
            <td><?=$contador?></td>
            <td><?=$movimiento_profesor['CODIGO_MOVIMIENTO']?></td>
            <td><?=$movimiento_profesor['CODIGO_PROFESOR']?></td>
   			<td><?=$movimiento_profesor['NOMBRE_PROFESOR']?></td>
   			<td align="center"><?=$movimiento_profesor['CREDITO_MOVIMIENTO']?></td>
            <td><?=$movimiento_profesor['USUARIO']?></td>
           <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalReversar<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>">Reversar</button></td>
<div class="modal fade" id="modalReversar<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Pago Credito                  <small>#<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?></small>
                </h4>
            ...
            <div class="modal-body">
              <form method="POST" action="confirmarReversionPagoCredito.php">

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Profesor</label>
                      <input type="text" id="simpleinput" name="nombreProfesor" value="<?=$movimiento_profesor['NOMBRE_PROFESOR']?>" class="form-control" autocomplete="off" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor</label>
                      <input type="text" id="simpleinput" name="valor" value="<?=$movimiento_profesor['CREDITO_MOVIMIENTO']?>" class="form-control" disabled>
                  </div>
        
            </div>
            <div class="modal-footer">
            	<input name="codigoProfesor" type="hidden" id="numeroPedido" value="<?=$movimiento_profesor['CODIGO_PROFESOR']?>
               " />
               <input name="nombreProfesor" type="hidden" id="numeroPedido" value="<?=$movimiento_profesor['NOMBRE_PROFESOR']?>
               " />
               <input name="valor" type="hidden" id="nombreCajero" value="<?=$movimiento_profesor['CREDITO_MOVIMIENTO']?>
               " />
               <input name="codigoMovimiento" type="hidden" id="valorPedido" value="<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>
               " />
...
?>
<?php echo isset($_SESSION['errores']) ? mostrar_error($_SESSION['errores'], 'nombreProfesor') : ''; ?>
