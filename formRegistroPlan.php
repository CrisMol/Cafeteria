...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Registro Plan <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
      ...
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="guardarRegistroPlan.php">

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Codigo Estudiante</label>
                        <input type="text" name="codigoEstudiante" id="simpleinput" class="form-control" value="1004" disabled>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Estudiante</label>
                        <input type="text" name="codigoEstudiante" id="simpleinput" class="form-control" value="Alban Laines Darla" disabled>
                    </div>

                      <div class="form-group">
                          <label class="form-label" for="single-default">
                              Seleccion Plan Alimentaci&oacute;n
                          </label>
                          <select class="form-control w-100" name="plan" id="single-default" required>
                          <option value="">Seleccione</option>
                          <option value="1">Desayuno</option>
                          <option value="2">Almuerzo</option>
                          <option value="3">Desayuno y Almuerzo</option>
                          </select>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control w-100" name="estado" id="single-default" required>
                          <option value="">Seleccione</option>
                      ...
                      <button type="submit" class="btn btn-info btn-primary">Guardar Registro</button>
                      </div>
                      </form>
