...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Ingresar Factura <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
      ...
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="ingresarFacturaProveedor.php">
                      <div class="form-group">
                          <label class="form-label" for="single-default">
                              Proveedor
                          </label>
                          <select class="select2 form-control w-100" name="idProveedor" id="single-default" required>
                          <option value="">Digite o seleccione proveedor</option>
<option value="1">Cafeteri.sa</option><option value="2">Productos Propios Cocina</option>                          </select>
                      </div>
