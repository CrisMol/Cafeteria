...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Recargas Profesor <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
...
<tr>
                                ...
                                <td align="right"><?=$profesor['SALDO_PROFESOR']?></td>
                                <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal<?=$profesor['CODIGO_PROFESOR']?>">Recargar</button></td>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Recarga Profesor <?=$profesor['CODIGO_PROFESOR']?>                    <small class="m-0 text-muted">
            ...
            <div class="modal-body">
              <form method="POST" action="procesarRecargaProfesorInt.php">
