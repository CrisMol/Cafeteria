...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Profesores <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
          ...
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                      <div class="panel-tag">
                        <button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#nuevoProfesor">
...
<div class="modal fade" id="modalEditar1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Profesor Codigo1714764221                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="guardarCambiosProfesor.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Apellidos</label>
                      <input type="text" id="simpleinput" name="apellidosProfesor" value="Moreno Prieto" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre</label>
                      <input type="text" id="simpleinput" name="nombreProfesor" value="Juan Francisco" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Cupo Credito</label>
                      <input type="text" id="simpleinput" name="cupoCredito" value="50.00" class="form-control" autocomplete="off" required>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idProfesor" type="hidden" id="idProfesor" value="1" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
  ...
  <!-- Modal -->
  <div class="modal fade" id="nuevoProfesor" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title">
                      Registro Nuevo Profesor                  </h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true"><i class="fal fa-times"></i></span>
                  </button>
              </div>
              <div class="modal-body">
                <form method="get" action="guardarNuevoProfesor.php">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" id="simpleinput" name="codigoProfesor" placeholder="Digite codigo" class="form-control" autocomplete="off" required>
                  </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Apellidos</label>
                        <input type="text" id="simpleinput" name="apellidosProfesor" placeholder="Digite apellidos" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre</label>
                        <input type="text" id="simpleinput" name="nombreProfesor" placeholder="Digite nombre" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Cupo Credito</label>
                        <input type="text" id="simpleinput" name="cupoCredito" value="0" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">E-mail</label>
                        <input type="email" id="simpleinput" name="email" placeholder="Digite email" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Celular</label>
                        <input type="text" id="simpleinput" name="celular" placeholder="Digite celular" class="form-control" autocomplete="off" required>
                    </div>

              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                  <button type="submit" class="btn btn-info btn-primary">Guardar Profesor</button>
              </div>
              </form>
          </div>
      </div>
