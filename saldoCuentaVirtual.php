...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Cuenta Virtual</li>
        <li class="breadcrumb-item">Saldo</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Saldo Cuenta Virtual <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="alert alert-danger alert-dismissible fade show" role="alert">
          ...
          <strong>NO aplica en esta plataforma!</strong>.
      </div></main>
