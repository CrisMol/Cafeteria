...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Estudiantes Registrados <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Estudiantes Registrados Plan Alimentaci&oacute;n</i></span>
                  </h2>
                      ...
                      <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                          ...
                          <tbody>
                            <tr>
                                  <td>1</td>
                                  <td>1008</td>
                                  <td>Loor Maldonado Xavier</td>
                                  <td align="center">Si</td>
                                  <td align="center">No</td>
                                  <td align="center">Activo</td>
                                  <td align="center"><a href="desactivarPlan.php?idPlan=1"><button type="button" class="btn btn-xs btn-primary">Suspender</button></a>&nbsp;&nbsp;<a href="editarPlan.php?idPlan=1"><button type="button" class="btn btn-xs btn-info">Editar</button></a>&nbsp;&nbsp;<a href="eliminarPlan.php?idPlan=1"><button type="button" class="btn btn-xs btn-danger">Eliminar</button></a></td>
                                  </tr>                          </tfoot>
                      </table>
                      <!-- datatable end -->
                  </div>
