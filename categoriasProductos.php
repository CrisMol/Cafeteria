...
<tr>
                                  <td>1</td>
                                  <td>Almuerzo</td>
                                  <td><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre9">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar9">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre9" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">

                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Almuerzo" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="9" />
...
<!-- Modal -->
<div class="modal fade" id="modalEditar9" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="guardarPuntosVentaSeleccionados.php">


<label>
<input type="checkbox" name="idPunto[]" value="1">
<i></i>Cafetería Proyectos Corpsunrise</label><br><label>
<input type="checkbox" name="idPunto[]" value="2" checked="checked">
<i></i>Colegio Sagrados Corazones De Rumipamba</label><br><div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="9" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
...
<tr>
                                  <td>2</td>
                                  <td>Bebidas</td>
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre1">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar1">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Bebidas" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="1" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Bebidas</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<label>
<input type="checkbox" name="idPunto[]" value="1" checked="checked">
<i></i>Cafetería Proyectos Corpsunrise</label><br><label>
<input type="checkbox" name="idPunto[]" value="2" checked="checked">
<i></i>Colegio Sagrados Corazones De Rumipamba</label><br><div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="1" />
...
<tr>
                                  ...
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre8">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar8">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Comidas Rapida" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="8" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Comidas Rapida</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  ...
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre3">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar3">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Desayunos" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="3" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Desayunos</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  ...
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre6">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar6">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Especialidades" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="6" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Especialidades</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  ...
                                  <td><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre5">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar5">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="General" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="5" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria General</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  ...
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre7">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar7">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Lunch" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="7" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Lunch</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  ...
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre4">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar4">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Postres" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="4" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Postres</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  <td>9</td>
                                  <td>Productos Reforzados Y Antojitos</td>
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre10">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar10">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre10" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Productos Reforzados Y Antojitos" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="10" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<!-- Modal -->
<div class="modal fade" id="modalEditar10" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Productos Reforzados Y Antojitos</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
...
<tr>
                                  ...
                                  <td><li>Cafetería Proyectos Corpsunrise</li><li>Colegio Sagrados Corazones De Rumipamba</li></td>
                                  <td align="center">
                                  <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalCambiarNombre2">Cambiar Nombre</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar2">Puntos Venta</button>
                                  </td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="modalCambiarNombre2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="actualizarNombreCategoria.php">
                ...
                <div class="form-group">
                    <label class="form-label" for="simpleinput">Nombre Categoria</label>
                    <input type="text" id="simpleinput" name="nombreCategoria" value="Snacks" class="form-control" required>
                </div>

<div class="modal-footer">
   <input name="idCategoria" type="hidden" id="idCategoria" value="2" />
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
</div>
</form>
...
<div class="modal fade" id="modalEditar2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Activar Categoria Puntos de Venta                    <small>Categoria Snacks</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
