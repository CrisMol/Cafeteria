...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Editar Plan Alimentaci&oacute;n <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Plan Registrado <span class="fw-300"><i>Actual</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="guardarCambiosPlan.php">

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Codigo Estudiante</label>
                        <input type="text" name="codigoEstudiante" id="simpleinput" class="form-control" value="1008" disabled>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Estudiante</label>
                        <input type="text" name="codigoEstudiante" id="simpleinput" class="form-control" value="Loor Maldonado Xavier" disabled>
                    </div>
                      ...
                      <div class="form-group">
                          ...
                          <select class="select2 form-control w-100" name="plan" id="single-default" required>
<option value="1">Desayuno</option>
                      ...
                      <div class="modal-footer">
                       <input name="idPlan" type="hidden" id="idPlan" value="1" />
