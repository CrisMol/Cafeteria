...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Resumen Ventas Periodo <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
          ...
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                    <form method="get" action="resumenVentasFecha.php">
                      <div class="form-group row">
                          ...
                          <div class="col-12 col-lg-6">
                              <div class="input-daterange input-group" id="datepicker-5">
                                  <input type="text" class="form-control" value="10/01/2020" name="start" autocomplete="off">
                                  <div class="input-group-append input-group-prepend">
                                      <span class="input-group-text fs-xl"><i class="fal fa-ellipsis-h"></i></span>
                                  </div>
                                  <input type="text" class="form-control" value="10/05/2020" name="end" autocomplete="off">
                              </div>
                          </div>
                      </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Ventas <span class="fw-300"><i>Periodo del 2020-10-01 al 2020-10-05</i></span>
                  </h2>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Productos <span class="fw-300"><i>Vendidos Periodo del 2020-10-01 al 2020-10-05</i></span>
                  </h2>
                  <div class="panel-toolbar">
                    <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Pantalla Completa"></button>
                  </div>
