...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Planes Alimentaci&oacute;n</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Planes Alimentaci&oacute;n <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Estudiantes <span class="fw-300"><i>No Registrados Plan Alimentaci&oacute;n</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="formRegistroPlan.php">
                      <div class="form-group">
                          <label class="form-label" for="single-default">
                              Estudiante
                          </label>
                          <select class="select2 form-control w-100" name="codigoEstudiante" id="single-default" required>
                          <option value="">Digite o seleccione estudiante</option>
<option value="1004">Alban Laines Darla - Codigo 1004</option><option value="1005">Delgado Santos Andres - Codigo 1005</option><option value="1006">Delgado Santos Andrea - Codigo 1006</option><option value="1007">Loor Mardonado Julian - Codigo 1007</option><option value="1009">Martinez Jurado Patricio - Codigo 1009</option><option value="1001">Merino Moreno Daniel Alejandro - Codigo 1001</option><option value="1002">Merino Moreno Diego Andres - Codigo 1002</option><option value="1003">Merino Moreno Juan Francisco - Codigo 1003</option><option value="1101">Viteri Ramos Cristian Andres - Codigo 1101</option></select>
                      </div>
