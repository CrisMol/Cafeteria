...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Cuadre Admin</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Cuadre Admin <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Cuadre Admin  <span class="fw-300"><i>Otra Fecha</i></span>
                  </h2>

              </div>
              <div class="panel-container show">
                  <div class="panel-content">
                    <form method="get" action="cuadreRecargasFecha.php">
                      <div class="form-group row">
                          <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Fecha Informe</label>
                          <div class="col-12 col-lg-6">
                              <div class="input-group">
                                  <input type="text" class="form-control " placeholder="Seleccione fecha" name="fechaCuadre" value="10/14/2020" id="datepicker-2" autocomplete="off" required>
                      ...
                      <button type="submit" class="btn btn-info btn-primary">Ver Cuadre Admin</button>
                      </div>
                    </form>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Recargas Admin <span class="fw-300"><i>Efectivo</i></span>
                  </h2>
                          ...
                          <table class="table table-bordered m-0">
                              <thead>
                                  <tr>
                                      ...
                                      <th>Transacciones</th>
                                      <th>Total Recargas / Pagos Cr&eacute;ditos</th>
                                  </tr>
                              </thead>
                              <tbody>
<tr>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Pagos Proveedores <span class="fw-300"><i>Admin</i></span>
                  </h2>
                  <div class="panel-toolbar">
                    <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Pantalla Completa"></button>
                  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Cuadre Caja  <span class="fw-300"><i>Admin</i></span>
                  </h2>
                  <div class="panel-toolbar">
                    <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Pantalla Completa"></button>
                  </div>
