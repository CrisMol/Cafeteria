...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Cr&eacute;ditos Profesor</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Reversiones Cr&eacute;ditos Profesores <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      &Uacute;ltimo <span class="fw-300"><i>Corte</i></span>
                  </h2>
