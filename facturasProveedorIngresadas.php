...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Facturas Ingresadas</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Facturas Ingresadas <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalProductos1602134198">Ver Productos</button></td>
                              </tr>                          </tbody>
                          <tfoot>
                              <tr>
                                <th>ID</th>
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalProductos1602134198" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title">
                      Factura Pedido #1602134198                  <small>Cafeteri.sa</small>
                  </h4>
