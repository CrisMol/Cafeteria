...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Familias <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
          ...
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                      <div class="panel-tag">
                        <button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#formNuevaFamilia">
                      ...
                      <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                          <thead>
                              <tr>
                                  ...
                                  <th>E-mail Notificaciones</th>
                                  <th>Celular Notificaciones</th>
                                  <th>&nbsp;</th>
                              </tr>
                          </thead>
                          <tbody>
<tr>
                                  ...
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar1">Editar</button></td>
                              </tr><!-- Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1714764220                    <small class="m-0 text-muted">
                        Merino Moreno                    </small>
                </h4>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                      <input type="text" id="simpleinput" name="emailNotificaciones" value="merino_daniel1@hotmail.com" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Celular Notificaciones</label>
                      <input type="number" id="simpleinput" name="celularNotificaciones" value="0991943124" class="form-control" autocomplete="off" required>
                  </div>

            </div>
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="1" />
...
<tr>
                                  <td>2</td>
                                  <td>1114764220</td>
                                  <td>Martinez Jurado</td>
                                  <td>sunrisecateringcorp@yahoo.com</td>
                                  <td>0991943124</td>
...
<div class="modal fade" id="modalEditar2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1114764220                    <small class="m-0 text-muted">
                        Martinez Jurado                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                      <input type="text" id="simpleinput" name="emailNotificaciones" value="sunrisecateringcorp@yahoo.com" class="form-control" autocomplete="off" required>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="2" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<tr>
                                  <td>3</td>
                                  <td>1214764220</td>
                                  <td>Delgado Santos</td>
                                  <td>d.merino@corpsunrise.com</td>
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar3">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1214764220                    <small class="m-0 text-muted">
                        Delgado Santos                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                      <input type="text" id="simpleinput" name="emailNotificaciones" value="d.merino@corpsunrise.com" class="form-control" autocomplete="off" required>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="3" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<tr>
                                  <td>4</td>
                                  <td>1314764220</td>
                                  <td>Loor Maldonado</td>
                                  <td>daniel.merino@katulatam.com</td>
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar4">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1314764220                    <small class="m-0 text-muted">
                        Loor Maldonado                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                      <input type="text" id="simpleinput" name="emailNotificaciones" value="daniel.merino@katulatam.com" class="form-control" autocomplete="off" required>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="4" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>1414764220</td>
                                  <td>Alban Laines</td>
                                  <td>ealban@corpsunrise.com</td>
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar5">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1414764220                    <small class="m-0 text-muted">
                        Alban Laines                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                      <input type="text" id="simpleinput" name="emailNotificaciones" value="ealban@corpsunrise.com" class="form-control" autocomplete="off" required>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="5" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>merino_daniel1@hotmail.com</td>
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar6">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1514764220                    <small class="m-0 text-muted">
                        Viteri Ramos                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
            ...
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="6" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>merino_daniel1@hotmail.com</td>
                                  <td>099766</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar7">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 170120                    <small class="m-0 text-muted">
                        Armijos Valle                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Celular Notificaciones</label>
                      <input type="number" id="simpleinput" name="celularNotificaciones" value="099766" class="form-control" autocomplete="off" required>
                  </div>

            </div>
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="7" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<tr>
                                  <td>8</td>
                                  <td>1525</td>
                                  <td>Tiwintza Yatza</td>
                                  <td>merino_daniel1@hotmail.com</td>
                                  <td>888</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar8">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia 1525                    <small class="m-0 text-muted">
                        Tiwintza Yatza                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosFamilia.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Celular Notificaciones</label>
                      <input type="number" id="simpleinput" name="celularNotificaciones" value="888" class="form-control" autocomplete="off" required>
                  </div>

            </div>
            <div class="modal-footer">
               <input name="idFamilia" type="hidden" id="idFamilia" value="8" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
  ...
  <!-- Modal -->
  <div class="modal fade" id="formNuevaFamilia" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title">
                      Registro Nueva Familia
                  </h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true"><i class="fal fa-times"></i></span>
                  </button>
              ...
              <div class="modal-body">
                <form method="get" action="guardarNuevaFamilia.php">

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Codigo Familia</label>
                        <input type="text" id="simpleinput" name="codigoFamilia" placeholder="Digite codigo familia" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Familia</label>
                        <input type="text" id="simpleinput" name="nombreFamilia" placeholder="Digite nombre familia" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                        <input type="email" id="simpleinput" name="emailNotificaciones" placeholder="Digite email notificaciones" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Celular Notificaciones</label>
                        <input type="number" id="simpleinput" name="celularNotificaciones" placeholder="Digite celular notificaciones" class="form-control" autocomplete="off" required>
                    </div>
