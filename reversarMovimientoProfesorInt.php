                  ...
                  <div class="panel-content">
                      <form>
                          <div class="form-group">
                              ...
                              <input type="text" id="simpleinput" value="1714764221" class="form-control" disabled>
                          </div>

                          <div class="form-group">
                              <label class="form-label" for="simpleinput">Apellidos</label>
                              <input type="text" id="simpleinput" value="Moreno Prieto" class="form-control" disabled>
                          </div>

                          <div class="form-group">
                              <label class="form-label" for="simpleinput">Nombre</label>
                              <input type="text" id="simpleinput" value="Juan Francisco" class="form-control" disabled>
                          </div>
                      ...
                      <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                          ...
                          <tbody>
                            <tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#reversarMov2">Rerversar</button></td></tr><!-- Modal -->
<div class="modal fade" id="reversarMov2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Reversar Movimiento ID#1                    <small>El valor sera debitado de la cuenta virtual. <br>Este proceso es irreversible.</small>
                </h4>
            ...
            <div class="modal-body">
              ...
              <form method="get" action="reversarMovimientoProfesorInt.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Fecha</label>
                      <input type="text" id="simpleinput" value="2020-10-05" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Hora</label>
                      <input type="text" id="simpleinput" value="19:53:41" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Descripcion</label>
                      <input type="text" id="simpleinput" value="Desayuno Americano" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor</label>
                      <input type="text" id="simpleinput" value="2.75" class="form-control" disabled>
                  </div>

            </div>
            <div class="modal-footer">
              <input name="idExtracto" type="hidden" id="idExtracto" value="2" />
...
<tr>
                                  ...
                                  <td>2020-10-03</td>
                                  <td>17:47:14</td>
                                  <td>Recarga Efectivo</td>
                                  <td align="center">1</td>
                                  <td align="right">0.00</td>
                                  <td align="right">5.00</td>
                                  <td align="center">&nbsp;</td></tr><!-- Modal -->
<div class="modal fade" id="reversarMov1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Reversar Movimiento ID#2                    <small>El valor sera debitado de la cuenta virtual. <br>Este proceso es irreversible.</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-body">
              ...
              <form method="get" action="reversarMovimientoProfesorInt.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Fecha</label>
                      <input type="text" id="simpleinput" value="2020-10-03" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Hora</label>
                      <input type="text" id="simpleinput" value="17:47:14" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Descripcion</label>
                      <input type="text" id="simpleinput" value="Recarga Efectivo" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor</label>
                      <input type="text" id="simpleinput" value="0.00" class="form-control" disabled>
                  </div>

            </div>
            <div class="modal-footer">
              <input name="idExtracto" type="hidden" id="idExtracto" value="1" />
              <input name="idProfesor" type="hidden" id="idProfesor" value="1" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Confirmar Reversi&oacute;n</button>
            </div>
