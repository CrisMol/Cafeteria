...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Seleccionar</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Seleccionar Productos <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Categoria <span class="fw-300"><i>Productos</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="verProductosCategoria.php">
                      <div class="form-group">
                          <label class="form-label" for="single-default">
                              Categoria Productos
                          </label>
                          <select class="select2 form-control w-100" name="idCategoria" id="single-default" required>
                          <option value="">Digite o seleccione categoria</option>
<?php
