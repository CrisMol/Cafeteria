...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Puntos Venta</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Puntos Venta <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Puntos de Venta <span class="fw-300"><i>Registrados</i></span>
                  </h2>
...
<div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <strong>Exito!</strong> El punto de venta se actualizo exitosamente.
    </div>
                      <div class="panel-tag">
                        <button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#modalNuevoPuntoVenta">
                            <span class="fal fa-warehouse"></span>
                            Nuevo Punto Venta
                        </button>
                      </div>
...
<tr>
                                  <td>1</td>
                                  <td>Cafetería Proyectos Corpsunrise</td>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Punto Venta                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="guardarCambiosPunto.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Punto Venta</label>
                      <input type="text" id="simpleinput" name="nombrePunto" value="Cafetería Proyectos Corpsunrise" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idPunto" type="hidden" id="idPunto" value="1" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosPunto.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Punto Venta</label>
                      <input type="text" id="simpleinput" name="nombrePunto" value="Cafeteria San Gabriel" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idPunto" type="hidden" id="idPunto" value="3" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<div class="modal fade" id="modalEditar2" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosPunto.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Punto Venta</label>
                      <input type="text" id="simpleinput" name="nombrePunto" value="Colegio Sagrados Corazones De Rumipamba" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idPunto" type="hidden" id="idPunto" value="2" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalNuevoPuntoVenta" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title">
              ...
              <div class="modal-body">
                <form method="get" action="guardarNuevoPunto.php">

                      <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Punto Venta</label>
                        <input type="text" id="simpleinput" name="nombrePunto" placeholder="Digite nombre" class="form-control" autocomplete="off" required>
                    </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                  <button type="submit" class="btn btn-info btn-primary">Guardar Punto</button>
              </div>
              </form>
          </div>
      </div>
