...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>
            Ingreso Administrativo - CAFETERISA
        </title>
                                ...
                                <div class="col col-md-6 col-lg-7 hidden-sm-down">
                                    ...
                                    <div class="d-sm-flex flex-column align-items-center justify-content-center d-md-block">
                                        ...
                                        <div class="d-flex flex-row opacity-70">
                                            <a href="https://www.facebook.com/appcafeterisa/" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-facebook-square"></i>
                                            </a>
                                            <a href="https://twitter.com/appcafeterisa" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-twitter-square"></i>
                                            </a>
                                            <a href="https://www.instagram.com/cafeterisa/" class="mr-2 fs-xxl text-white">
...
<form id="js-login" novalidate="" method="POST" action="login.php">
                            ...
                            <div class="position-absolute pos-bottom pos-left pos-right p-3 text-center text-white">
                                2011 - 2020 © Un producto de CORP SUNRISE&nbsp;<a href='https://www.cafeterisa.com.ec' class='text-white opacity-40 fw-500' title='gotbootstrap.com' target='_blank'>www.cafeterisa.com.ec</a>
                            </div>
                        </div>
                    </div>
                </div>
