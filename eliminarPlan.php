...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Eliminar Plan Alimentaci&oacute;n <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Estudiante Eliminar<span class="fw-300"><i>Plan</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="confirmarEliminarPlan.php">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          Plan Alimentaci&oacute;n
                          </label>
                          <select class="select2 form-control w-100" name="plan" id="single-default" disabled>
