...
?>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" id="simpleinput" value="<?=$profesor['CREDITO']?>" class="form-control" disabled>
                          </div>
...
<tr>
    ...
    <td><?=$movimiento_profesor['CANTIDAD_MOVIMIENTO']?></td>
    <td><?=$movimiento_profesor['DEBITO_MOVIMIENTO']?></td>
</tr>
<?php
        endwhile;
    endif;
