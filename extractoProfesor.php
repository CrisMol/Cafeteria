...
<main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Extracto Cr&eacute;ditos</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Extracto Cr&eacute;ditos Profesor <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                      <form>
                          ...
                          <div class="form-group">
                              <label class="form-label" for="simpleinput">Saldo Cr&eacute;dito</label>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Movimientos Cr&eacute;dito<span class="fw-300"><i>Registrados </i></span>
                  </h2>
                  <div class="panel-toolbar">
                      <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip" data-offset="0,10" data-original-title="Minimizar"></button>
                      <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Pantalla Completa"></button>
