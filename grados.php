...
?>
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Grados <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Grados <span class="fw-300"><i>Registrados</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                      <div class="panel-tag">
                        <button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#modalNuevoGrado">
                            Nuevo Grado
                        </button>
                      </div>

                      <?php echo isset($_SESSION['errores']) ? mostrar_error($_SESSION['errores'], 'grado') : ''; ?> 
...
?>
							  <tr>
                                  ...
                                  <td align="center">1 - <a href="verEstudiantesGrado.php?grado=Bac1">Ver Estudiantes</a></td>
                              </tr>
                          </tbody>
<?php
		endwhile;
...
?>
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalNuevoGrado" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-dhidden="true"><i class="fal fa-times"></i></span>
                  </button>
              </div>
              <div class="modal-body">
                <form method="POST" action="guardarGrado.php">

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Grado</label>
                        <input type="text" id="simpleinput" name="nombreGrado" placeholder="Digite grado" class="form-control" autocomplete="off" required>
                    </div>

              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Grado</button>
              </div>
              </form>
          </div>
      </div>
