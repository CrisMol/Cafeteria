...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Registrar RFID</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Registrar RFID <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid4">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1004                    <small>Alban Laines Darla</small>
                </h4>
            ...
            <div class="modal-body">
              <form method="get" action="guardarRFID.php">

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">#RFID</label>
                      <input type="text" id="simpleinput" name="rfid" placeholder="Click aqui y acerque el RFID" class="form-control" autocomplete="off" autofocus required>
                  </div>

            </div>
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="4" />
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid11">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid11" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo12345                    <small>Alban Laines Priscila</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="11" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid5">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1005                    <small>Delgado Santos Andres</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="5" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid6">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1006                    <small>Delgado Santos Andrea</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="6" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid8">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1008                    <small>Loor Maldonado Xavier</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="8" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  <td>6</td>
                                  <td>1007</td>
                                  <td>Loor Mardonado</td>
                                  <td>Julian</td>
                                  <td>Egb6</td>
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid7">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1007                    <small>Loor Mardonado Julian</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="7" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid9">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid9" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1009                    <small>Martinez Jurado Patricio</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="9" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid1">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1001                    <small>Merino Moreno Daniel Alejandro</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="1" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<div class="modal fade" id="formRfid2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1002                    <small>Merino Moreno Diego Andres</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="2" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid3">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1003                    <small>Merino Moreno Juan Francisco</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="3" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
...
<tr>
                                  ...
                                  <td>No Registra</td>
                                  <td>No Registra</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#formRfid10">Seleccionar</button></td>
                              </tr>
<!-- Modal -->
<div class="modal fade" id="formRfid10" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Registrar RFID Estudiante Codigo1101                    <small>Viteri Ramos Cristian Andres</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            ...
            <div class="modal-footer">
               <input name="idEstudiante" type="hidden" id="idEstudiante" value="10" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Registrar</button>
            </div>
            </form>
