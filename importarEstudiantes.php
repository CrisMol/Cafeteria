...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Importar Estudiantes <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Cargar <span class="fw-300"><i>Archivo</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="post" enctype="multipart/form-data" action="procesarArchivoEstudiantes.php">
                    <div class="panel-tag">
                        Descarga plantilla para importar estudiantes. Debe borrar los registros de ejemplo. <a href="plantillaImportarEstudiantes.csv"><button type="button" class="btn btn-xs btn-info">Descargar</button></a>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="inputGroupFile01" name="archivo" aria-describedby="inputGroupFileAddon01" required>
                      ...
                      <button type="submit" class="btn btn-info btn-primary">Importar Estudiantes</button>
                      </form>
                    </div>
                  </div>
              </div>
