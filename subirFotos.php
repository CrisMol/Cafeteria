...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Subir Fotos</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Subir Fotos <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
        ...
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Fotos <span class="fw-300"><i>Estudiantes & Profesores</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            El formato de la foto jpg (minisculas), el nombre de el archivo debe ser el codigo.jpg. Ejemplo: 100.jpg
                        </div>
                        <form action="upload.php" class="dropzone needsclick" style="min-height: 7rem;">
                            <div class="dz-message needsclick">
                                <i class="fal fa-cloud-upload text-muted mb-3"></i> <br>
                                <span class="text-uppercase">Suelta los archivos aqu&iacute; o haz clic para subir.</span>
                                <br>
                                <span class="fs-sm text-muted">Tambien puede seleccionar los archivos</strong> a subir. Recomendamos archivos menores a un 1MB</span>
                            </div>
                        </form>
                    </div>
                </div>
