          ...
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                    <form method="get" action="informeRecargasFecha.php">
                      <div class="form-group row">
                          <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Fecha Informe</label>
                          <div class="col-12 col-lg-6">
                              <div class="input-group">
                                  <input type="text" class="form-control " placeholder="Seleccione fecha" value="10/01/2020" name="fechaCuadre" id="datepicker-2" autocomplete="off" required>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Recargas <span class="fw-300"><i>2020-10-01</i></span>
                  </h2>
