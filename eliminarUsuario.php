...
<tr>
                                  ...
                                  <td>demoec</td>
                                  <td>Daniel Merino</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar2">Editar</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar2">Eliminar</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword2">Contrase&ntilde;a</button>
                                  &nbsp;
                                  <a href="privilegiosUsuario.php?idUsuario=2"><button type="button" class="btn btn-xs btn-outline-warning">Privilegios</button></a>
                                  </td>
                              </tr><!-- Modal editar-->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Usuario Administrativo                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="guardarCambiosUsuario.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Usuario</label>
                      <input type="text" id="simpleinput" name="nombreUsuario" value="Daniel Merino" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                    <label class="form-label" for="simpleinput">E-mail</label>
                    <input type="email" id="simpleinput" name="emailUsuario" value="daniel.merino@katulatam.com" class="form-control" autocomplete="off" required>
                </div>

            </div>
            <div class="modal-footer">
               <input name="idUsuarioAdmin" type="hidden" id="idUsuarioAdmin" value="2" />
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Eliminar Usuario Administrativo                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="eliminarUsuario.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Usuario</label>
                      <input type="text" id="simpleinput" name="nombreUsuario" value="Daniel Merino" class="form-control" disabled>
                  </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Restablecer Contrase&ntilde;a Usuario Administrativo                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="restablecerPasswordUsuario.php">
                  ...
                  <div class="form-group">
                    <label class="form-label" for="simpleinput">E-mail</label>
                    <input type="text" id="simpleinput" name="email" value="daniel.merino@katulatam.com" class="form-control" disabled>
                </div>
...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar8">Editar</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar8">Eliminar</button>
                                  &nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword8">Contrase&ntilde;a</button>
                                  &nbsp;
                                  <a href="privilegiosUsuario.php?idUsuario=8"><button type="button" class="btn btn-xs btn-outline-warning">Privilegios</button></a>
                                  </td>
                              </tr><!-- Modal editar-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosUsuario.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Usuario</label>
                      <input type="text" id="simpleinput" name="nombreUsuario" value="Estefania Alban" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                    <label class="form-label" for="simpleinput">E-mail</label>
                    <input type="email" id="simpleinput" name="emailUsuario" value="ealban@corpsunrise.com" class="form-control" autocomplete="off" required>
                </div>

            </div>
            <div class="modal-footer">
               <input name="idUsuarioAdmin" type="hidden" id="idUsuarioAdmin" value="8" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="eliminarUsuario.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Usuario</label>
                      <input type="text" id="simpleinput" name="nombreUsuario" value="Estefania Alban" class="form-control" disabled>
                  </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="restablecerPasswordUsuario.php">
                  ...
                  <div class="form-group">
                    <label class="form-label" for="simpleinput">E-mail</label>
                    <input type="text" id="simpleinput" name="email" value="ealban@corpsunrise.com" class="form-control" disabled>
                </div>
  ...
  <div class="modal fade" id="modalNuevoUsuario" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="get" action="guardarNuevoUsuario.php">

                <div class="form-group">
                    <label class="form-label" for="simpleinput">Usuario</label>
                    <input type="text" id="simpleinput" name="usuarioAdmin" placeholder="Digite usuario" class="form-control" autocomplete="off" required>
                </div>
