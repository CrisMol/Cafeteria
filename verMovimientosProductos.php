...
<main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Movimientos Producto</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Movimientos Producto <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Movimimientos <span class="fw-300"><i>Almuerzo Completo</i></span>
                  </h2>
...
<?php
	$contador = 0;
    $movimientos =conseguir_movimientos_productos($db, $_GET['idProducto']);
    if(!empty($movimientos) && mysqli_num_rows($movimientos) >= 1):
...
?>
                            <tr>
                                  ...
                                  <td align="center"><?=$movimiento['ENTRADA']?></td>
                                  <td align="center"><?=$movimiento['SALIDA']?></td>
                                  <td align="center"><?=$movimiento['SALDO']?></td>          
<?php
		endwhile;
	endif;
?>
