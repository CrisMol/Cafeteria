...
<main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Productos Categoria</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Productos Categoria Almuerzo <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
...
<?php
	$contador = 0;
	$categoria_producto = $_GET['idCategoria'];
    $productos = conseguir_productos_por_categoria($db, $categoria_producto);
