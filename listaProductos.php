...
?>
                            <tr>
                                  ...
                                  ?>
                                   ...
                                   <?php endif; ?>
                                  <td align="center">
                                  <button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#borrarProducto<?=$producto['CATEGORIA_PRODUCTO']?>">Eliminar</button>&nbsp;&nbsp;
                                  <button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto<?=$producto['CATEGORIA_PRODUCTO']?>">Editar</button></td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto<?=$producto['CATEGORIA_PRODUCTO']?>" tabindex="-1" role="dialog" aria-hidden="true">
...
<!-- Modal Eliminar-->
<div class="modal fade" id="borrarProducto<?=$producto['CATEGORIA_PRODUCTO']?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
