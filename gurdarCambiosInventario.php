                      ...
                      <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                          ...
                          <tbody>
                            <tr>
                                  ...
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto19">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto19">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Bebida 10 Oz                </h4>
            ...
            <div class="modal-body">
              <form method="POST" action="gurdarCambiosInventario.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="simpleinput" name="inventario" value="-4" class="form-control" required>
                  </div>
            ...
            <div class="modal-footer">
              <input name="proceso" type="hidden" id="proceso" value="1602838726" />
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto19" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Bebida 10 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto20">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto20">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto20" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Bebida 16 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="gurdarCambiosInventario.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Cantidad Inventario</label>
                      <input type="text" id="simpleinput" name="inventario" value="0" class="form-control" required>
                  </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto20" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Bebida 16 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td>Bebida 5,5 Oz</td>
                                  <td align="center">0</td>
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto17">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto17">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto17" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Bebida 5,5 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto17" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Bebida 5,5 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td>Bebida 7 Oz</td>
                                  <td align="center">0</td>
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto18">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto18">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto18" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Bebida 7 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto18" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Bebida 7 Oz                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td align="center">0</td>
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto22">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto22">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto22" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Bebida Botella 500ml                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto22" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Bebida Botella 500ml                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td align="center">0</td>
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto21">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto21">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto21" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Bebida Caliente / Aromatica                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto21" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Bebida Caliente / Aromatica                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td align="center">0</td>
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto9">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto9">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto9" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Lunch Completo Del Dia                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto9" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Lunch Completo Del Dia                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto7">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto7">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Lunch Completo Especialidad                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="gurdarCambiosInventario.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Cantidad Inventario</label>
                      <input type="text" id="simpleinput" name="inventario" value="-3" class="form-control" required>
                  </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Lunch Completo Especialidad                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td>Lunch Del Dia</td>
                                  <td align="center">0</td>
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto8">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto8">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Lunch Del Dia                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto8" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Lunch Del Dia                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn-xs btn-info" data-toggle="modal" data-target="#editarProducto3">Modificar</button>
                                  &nbsp;&nbsp;<button type="button" class="btn-xs btn-danger" data-toggle="modal" data-target="#bajaProducto3">Bajas</button>
                                  </td>
                                  </tr><!-- Modal -->
<div class="modal fade" id="editarProducto3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Modificar Inventario Proteina Adicional                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="gurdarCambiosInventario.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Cantidad Inventario</label>
                      <input type="text" id="simpleinput" name="inventario" value="-5" class="form-control" required>
                  </div>
...
<!-- Modal bajas-->
<div class="modal fade" id="bajaProducto3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Baja Inventario Proteina Adicional                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
