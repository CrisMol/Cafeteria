...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modal<?=$familia['CODIGO']?>">Editar</button></td>
                              </tr><!-- Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Familia <?=$familia['CODIGO']?>                  <small class="m-0 text-muted">
            ...
            <div class="modal-body">
              <form method="POST" action="guardarFamilia.php?editar=<?=$familia['CODIGO']?>">

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail Notificaciones</label>
                      <input type="text" id="simpleinput" name="emailNotificaciones" value="<?=$familia['EMAIL']?>" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Celular Notificaciones</label>
                      <input type="text" id="simpleinput" name="celularNotificaciones" value="<?=$familia['CELULAR']?>" class="form-control" autocomplete="off" required>
                  </div>

            </div>
            <div class="modal-footer">
              <input name="idFamilia" type="hidden" id="idFamilia" value="<?=$familia['CODIGO']?>" />
