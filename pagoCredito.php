...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Pago Cr&eacute;dito <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Cr&eacute;ditos <span class="fw-300"><i>Autorizados</i></span>
                </h2>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Pago Credito C&oacute;digo <?=$profesor['CODIGO_PROFESOR']?>                    <small class="m-0 text-muted">
                        <?=$profesor['APELLIDOS_PROFESOR']?> <?=$profesor['NOMBRE_PROFESOR']?>                  </small>
                </h4>
            ...
            <div class="modal-body">
              <form method="POST" action="procesarRecargaPago.php">

                <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor Pago</label>
                      <input type="number" id="simpleinput" name="valorPago" placeholder="Digite valor pago" class="form-control" autocomplete="off" required>
                  </div>
