  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Profesor <span class="fw-300"><i>Seleccionado</i></span>
                  </h2>
...
?>
                            <tr>
                                  <td><?=$contador?></td>
                                  <td><?=$movimiento_profesor['FECHA_MOVIMIENTO']?></td>
                                  <td><?=$movimiento_profesor['HORA_MOVIMIENTO']?></td>
                                  <td><?=$movimiento_profesor['DESCRIPCION_MOVIMIENTO']?></td>
                                  <td align="center"><?=$movimiento_profesor['CANTIDAD_MOVIMIENTO']?></td>
                                  <td align="right"><?=$movimiento_profesor['DEBITO_MOVIMIENTO']?></td>
                                  <td align="right"><?=$movimiento_profesor['CREDITO_MOVIMIENTO']?></td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#reversarMov<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>">Rerversar</button></td></tr><!-- Modal -->
<div class="modal fade" id="reversarMov<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Reversar Movimiento ID#<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>                  <small>El valor sera debitado de la cuenta virtual. <br>Este proceso es irreversible.</small>
                </h4>
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="reversarMovimientoProfesorInt.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Fecha</label>
                      <input name="fechaMovimiento" type="text" id="simpleinput" value="<?=$movimiento_profesor['FECHA_MOVIMIENTO']?>" class="form-control"  disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Hora</label>
                      <input type="text" id="simpleinput" value="<?=$movimiento_profesor['HORA_MOVIMIENTO']?>" class="form-control" name="horaMovimiento" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Descripcion</label>
                      <input type="text" id="simpleinput" value="<?=$movimiento_profesor['DESCRIPCION_MOVIMIENTO']?>" class="form-control"  name="DescripcionMovimiento" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor</label>
                      <input type="text" id="simpleinput" value="<?=$movimiento_profesor['CREDITO_MOVIMIENTO']?>" class="form-control" name="CreditoMovimiento" disabled>
                  </div>

            </div>
            <div class="modal-footer">
              <input name="Descripcion" type="hidden" id="Descripcion" value="<?=$movimiento_profesor['DESCRIPCION_MOVIMIENTO']?>" />
              <input name="valor" type="hidden" id="valor" value="<?=$movimiento_profesor['CREDITO_MOVIMIENTO']?>" />
              <input name="idExtracto" type="hidden" id="idExtracto" value="<?=$movimiento_profesor['CODIGO_MOVIMIENTO']?>" />
              <input name="idProfesor" type="hidden" id="idProfesor" value="<?=$movimiento_profesor['CODIGO_PROFESOR']?>" />
