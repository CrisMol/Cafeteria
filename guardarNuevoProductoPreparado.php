...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Nuevo Producto Preparado Propio<span class='fw-300'> Dashboard</span>
        </h1>
  </div>
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Tipo Preparado Propio <span class="fw-300"><i>Producto</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                    <div class="panel-tag">
                        Este producto sera adicionado a su lista de productos de forma inmediata.
                    </div>
                  <form method="get" action="guardarNuevoProductoPreparado.php">
...
<option value="9">Almuerzo</option><option value="1">Bebidas</option><option value="8">Comidas Rapida</option><option value="3">Desayunos</option><option value="6">Especialidades</option><option value="5">General</option><option value="7">Lunch</option><option value="4">Postres</option><option value="10">Productos Reforzados Y Antojitos</option><option value="2">Snacks</option>                        </select>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="addon-wrapping-left">Codigo</label>
                        <div class="input-group flex-nowrap">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fal fa-hashtag fs-xl"></i></span>
                            </div>
                            <input id="addon-wrapping-left" type="text" class="form-control" value="124" aria-label="Username" aria-describedby="addon-wrapping-left" autocomplete="off" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input id="addon-wrapping-left" type="text" class="form-control" name="nombreProducto" placeholder="Digite descripci&oacute;n producto" maxlength="30" aria-label="Username" aria-describedby="addon-wrapping-left" autocomplete="off" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="basic-url">Informaci&oacute;n Adicional</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Descripci&oacute;n</span>
                            </div>
                            <textarea class="form-control" name="infoAdicional" aria-label="With textarea" autocomplete="off"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input id="addon-wrapping-left" type="text" class="form-control" name="ventaProducto" placeholder="Digite precio venta producto" aria-label="Username" aria-describedby="addon-wrapping-left" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input name="tipoProducto" type="hidden" id="tipoProducto" value="1" />
                      <input name="codigoProducto" type="hidden" id="codigoProducto" value="124" />
