...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar<?=$proveedor['CODIGO_PROVEEDOR']?>">Editar</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalEditar<?=$proveedor['CODIGO_PROVEEDOR']?>" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosProveedor.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="simpleinput" name="nombreProveedor" value="<?=$proveedor['NOMBRE']?>" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Identificaci&oacute;n</label>
                      <input type="text" id="simpleinput" name="identificacion" value="<?=$proveedor['CODIGO']?>" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Contacto</label>
                      <input type="text" id="simpleinput" name="contacto" value="<?=$proveedor['VENDEDOR']?>" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail</label>
                      <input type="email" id="simpleinput" name="emailProveedor" value="<?=$proveedor['EMAIL']?>" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Tel&eacute;fono</label>
                      <input type="text" id="simpleinput" name="telefonoProveedor" value="<?=$proveedor['TELEFONO']?>" class="form-control" autocomplete="off" required>
                  </div>
  ...
  <div class="modal fade" id="modalNuevoProveedor" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="guardarNuevoProveedor.php">
...
<?php echo isset($_SESSION['errores']) ? mostrar_error($_SESSION['errores'], 'identificacion') : ''; ?>
<?php borrar_error();?>
</main>
