...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Proveedores <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Proveedores <span class="fw-300"><i>Registrados</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                      <div class="panel-tag">
                        <button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#modalNuevoProveedor">
...
<tr>
                                  ...
                                  <td>1714764220001</td>
                                  <td>Cafeteri.sa</td>
                                  <td>Estefania Alban</td>
                                  <td>clientes@cafeterisa.com</td>
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar1">Editar</button></td>
                              </tr><!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosProveedor.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Proveedor</label>
                      <input type="text" id="simpleinput" name="nombreProveedor" value="Cafeteri.sa" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Identificaci&oacute;n</label>
                      <input type="text" id="simpleinput" name="identificacion" value="1714764220001" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Contacto</label>
                      <input type="text" id="simpleinput" name="contacto" value="Estefania Alban" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail</label>
                      <input type="email" id="simpleinput" name="emailProveedor" value="clientes@cafeterisa.com" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Tel&eacute;fono</label>
                      <input type="text" id="simpleinput" name="telefonoProveedor" value="0991943124" class="form-control" autocomplete="off" required>
                  </div>
...
<tr>
                                  <td>2</td>
                                  <td>1714764220</td>
                                  <td>Productos Propios Cocina</td>
                                  <td>Corpsunrise</td>
                                  <td>d.merino@corpsunrise.com</td>
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalEditar2">Editar</button></td>
                              </tr><!-- Modal -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="get" action="guardarCambiosProveedor.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Proveedor</label>
                      <input type="text" id="simpleinput" name="nombreProveedor" value="Productos Propios Cocina" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Identificaci&oacute;n</label>
                      <input type="text" id="simpleinput" name="identificacion" value="1714764220" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Contacto</label>
                      <input type="text" id="simpleinput" name="contacto" value="Corpsunrise" class="form-control" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">E-mail</label>
                      <input type="email" id="simpleinput" name="emailProveedor" value="d.merino@corpsunrise.com" class="form-control" autocomplete="off" required>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idProveedor" type="hidden" id="idProveedor" value="2" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
  ...
  <div class="modal fade" id="modalNuevoProveedor" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title">
                      Registro Nuevo Proveedor                  </h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true"><i class="fal fa-times"></i></span>
                  </button>
              </div>
              <div class="modal-body">
                <form method="get" action="guardarNuevoProveedor.php">

                      <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Proveedor</label>
                        <input type="text" id="simpleinput" name="nombreProveedor" placeholder="Digite nombre" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Identificaci&oacute;n</label>
                        <input type="text" id="simpleinput" name="identificacion" placeholder="Digite identificaci&oacute;n" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Contacto</label>
                        <input type="text" id="simpleinput" name="contacto" placeholder="Digite nombre contacto" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">E-mail</label>
                        <input type="text" id="simpleinput" name="emailProveedor" placeholder="Digite e-mail" class="form-control" autocomplete="off" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="simpleinput">Tel&eacute;fono</label>
                        <input type="text" id="simpleinput" name="telefonoProveedor" placeholder="Digite tel&eacute;fono" class="form-control" autocomplete="off" required>
                    </div>

              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                  <button type="submit" class="btn btn-info btn-primary">Guardar Proveedor</button>
              </div>
              </form>
          </div>
      </div>
