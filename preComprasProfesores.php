...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Pre Compras</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Pre Compras Profesores <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Pre Compras Profesores <span class="fw-300"><i>Pendientes Entrega</i></span>
                  </h2>
                      ...
                      <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                          ...
                          <tbody>
                            <tr>
                                                                  ...
                                                                  <td>19:53:41</td>
                                                                  <td>1714764221</td>
                                                                  <td>Moreno Prieto Juan Francisco</td>
                                                                  <td>Plataforma</td>
                                                                  <td><li>Desayuno Americano X 1</li></td>
                                                              </tr>                          </tfoot>
                      </table>
                      <!-- datatable end -->
                  </div>
