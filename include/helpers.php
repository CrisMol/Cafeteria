<?php
	...
	function conseguir_profesores($conexion){
		$sql = "SELECT ID_PROF AS CODIGO_PROFESOR, APELLIDO_PROF AS APELLIDOS_PROFESOR, NOM_PROF AS NOMBRE_PROFESOR, ".
			   "SALDO_PROF AS SALDO_PROFESOR, CREDI_PROF AS CREDITO FROM profesor ORDER BY ID_PROF ASC;";
	...
	//Conseguir Productos
	function conseguir_productos($conexion){
		$sql = "SELECT p.ID_PRODUCTO AS CODIGO_PRODUCTO, c.NOM_CATEPROD AS CATEGORIA_PRODUCTO, COD_PTOVENTA AS CODIGO_PUNTO, ".
				...
				"PRECIO_VENTA AS PRECIO, ESTADO_INVE AS ESTADO_INVENTARIO, ESTADO_PRECO AS ESTADO_PRECOMPRA FROM ".
