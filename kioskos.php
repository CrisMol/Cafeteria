...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Kioskos</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Kioskos Autoatenci&oacute;n <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Estado  <span class="fw-300"><i>Kioskos</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="guardarcambiosKiosko.php">

                    <div class="form-group">
                        <label class="form-label" for="example-select">Estado Kioskos</label>
                        <select class="form-control" id="example-select" name="estadoKioskos">
