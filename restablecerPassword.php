...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
        <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
            <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                <span class="mr-2">
                    <img src="img/cafeterisapng" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                </span>
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Restablecer</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Restablecer Contrase&ntilde;a Familia <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
...
<tr>
                                  ...
                                  <td>0991943124</td>
                                  <td align="center"><button type="button" class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modalEditar1">Restablecer</button></td>
                              </tr><!-- Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Restablecer Contrase&ntilde;a Familia 1714764220                    <small class="m-0 text-muted">
                        Merino Moreno                    </small>
                </h4>
            ...
            <div class="modal-body">
              <form method="get" action="procesarRestablecerPassword.php">
              <p>La nueva contrase&ntilde;a sera el mismo coodigo de familia</p>
            </div>
            <div class="modal-footer">
              <input name="codigoFamilia" type="hidden" id="codigoFamilia" value="1714764220" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Restablecer</button>
            </div>
            </form>
        </div>
    </div>
              ...
              <div class="modal-body">
                <form method="get" action="guardarNuevaFamilia.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="simpleinput" name="celularNotificaciones" placeholder="Digite celular notificaciones" class="form-control" autocomplete="off" required>
                    </div>
