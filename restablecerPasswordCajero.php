...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Cajeros</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Cajeros POS <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Cajeros POS <span class="fw-300"><i>Registrados</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                      <div class="panel-tag">
                        <button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#modalNuevoCajero">
...
<tr>
                                  <td>1</td>
                                  <td>cajero1</td>
                                  <td>Dreiner Zambrano</td>
                                  <td>Colegio Sagrados Corazones De Rumipamba</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar3">Editar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar3">Eliminar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword3">Restablecer Contrase&ntilde;a</button>
                                  </td>
                              </tr><!-- Modal editar-->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Editar Cajero POS                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="guardarCambiosCajero.php">


                <div class="form-group">
                    <label class="form-label" for="example-select">Punto de Venta</label>
                    <select class="form-control" name="idPuntoVenta" id="example-select" required>
<option value="2">Colegio Sagrados Corazones De Rumipamba</option><option value="1">Cafetería Proyectos Corpsunrise</option><option value="2">Colegio Sagrados Corazones De Rumipamba</option>                  </select>
                </div>

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Dreiner Zambrano" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idCajero" type="hidden" id="idCajero" value="3" />
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Eliminar Cajero POS                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="eliminarCajero.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Dreiner Zambrano" class="form-control" disabled>
                  </div>
            ...
            <div class="modal-footer">
               <input name="idCajero" type="hidden" id="idCajero" value="3" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Eliminar Cajero</button>
            </div>
            </form>
        </div>
    </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Restablecer Contrase&ntilde;a Cajero POS                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
            </div>
            <div class="modal-body">
              <form method="get" action="restablecerPasswordCajero.php">
...
<tr>
                                  <td>2</td>
                                  <td>cajero2</td>
                                  <td>Estefanía Albán</td>
                                  <td>Colegio Sagrados Corazones De Rumipamba</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar4">Editar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar4">Eliminar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword4">Restablecer Contrase&ntilde;a</button>
                                  </td>
                              </tr><!-- Modal editar-->
...
<option value="2">Colegio Sagrados Corazones De Rumipamba</option><option value="1">Cafetería Proyectos Corpsunrise</option><option value="2">Colegio Sagrados Corazones De Rumipamba</option>                  </select>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Estefanía Albán" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idCajero" type="hidden" id="idCajero" value="4" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="eliminarCajero.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Estefanía Albán" class="form-control" disabled>
                  </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword4" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
...
<tr>
                                  <td>3</td>
                                  <td>cajero4</td>
                                  <td>Mónica Gonzales</td>
                                  <td>Colegio Sagrados Corazones De Rumipamba</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar6">Editar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar6">Eliminar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword6">Restablecer Contrase&ntilde;a</button>
                                  </td>
                              </tr><!-- Modal editar-->
...
<option value="2">Colegio Sagrados Corazones De Rumipamba</option><option value="1">Cafetería Proyectos Corpsunrise</option><option value="2">Colegio Sagrados Corazones De Rumipamba</option>                  </select>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Mónica Gonzales" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idCajero" type="hidden" id="idCajero" value="6" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="eliminarCajero.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Mónica Gonzales" class="form-control" disabled>
                  </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword6" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
...
<tr>
                                  <td>4</td>
                                  <td>admin proyecto</td>
                                  <td>Oriana Orta</td>
                                  <td>Colegio Sagrados Corazones De Rumipamba</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar7">Editar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar7">Eliminar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword7">Restablecer Contrase&ntilde;a</button>
                                  </td>
                              </tr><!-- Modal editar-->
...
<option value="2">Colegio Sagrados Corazones De Rumipamba</option><option value="1">Cafetería Proyectos Corpsunrise</option><option value="2">Colegio Sagrados Corazones De Rumipamba</option>                  </select>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Oriana Orta" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idCajero" type="hidden" id="idCajero" value="7" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="eliminarCajero.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Oriana Orta" class="form-control" disabled>
                  </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword7" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
...
<tr>
                                  ...
                                  <td>Pilar Laines</td>
                                  <td>Colegio Sagrados Corazones De Rumipamba</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#modalEditar5">Editar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modalEliminar5">Eliminar</button>
                                  &nbsp;&nbsp;
                                  <button type="button" class="btn btn-xs btn-outline-success" data-toggle="modal" data-target="#modalPassword5">Restablecer Contrase&ntilde;a</button>
                                  </td>
                              </tr><!-- Modal editar-->
...
<option value="2">Colegio Sagrados Corazones De Rumipamba</option><option value="1">Cafetería Proyectos Corpsunrise</option><option value="2">Colegio Sagrados Corazones De Rumipamba</option>                  </select>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Pilar Laines" class="form-control" autocomplete="off" required>
                  </div>


            </div>
            <div class="modal-footer">
               <input name="idCajero" type="hidden" id="idCajero" value="5" />
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-info btn-primary">Guardar Cambios</button>
            </div>
            </form>
...
<!-- Modal eliminar-->
<div class="modal fade" id="modalEliminar5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
            ...
            <div class="modal-body">
              <form method="get" action="eliminarCajero.php">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Nombre Cajero</label>
                      <input type="text" id="simpleinput" name="nombreCajero" value="Pilar Laines" class="form-control" disabled>
                  </div>
...
<!-- Modal password-->
<div class="modal fade" id="modalPassword5" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalNuevoCajero" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title">
                      Registro Nuevo Cajero                  </h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true"><i class="fal fa-times"></i></span>
                  </button>
              </div>
              <div class="modal-body">
                <form method="get" action="guardarNuevoCajero.php">

                  <div class="form-group">
                      <label class="form-label" for="example-select">Punto de Venta</label>
                      <select class="form-control" name="idPuntoVenta" id="example-select" required>
                          <option value="">Seleccione punto venta</option>
<option value="1">Cafetería Proyectos Corpsunrise</option><option value="2">Colegio Sagrados Corazones De Rumipamba</option>                    </select>
                  </div>

                  <div class="form-group">
                    <label class="form-label" for="simpleinput">usuario</label>
                    <input type="text" id="simpleinput" name="usuarioCajero" placeholder="Digite usuario" class="form-control" autocomplete="off" required>
                </div>

                      <div class="form-group">
                        <label class="form-label" for="simpleinput">Nombre Cajero</label>
                        <input type="text" id="simpleinput" name="nombreCajero" placeholder="Digite nombre" class="form-control" autocomplete="off" required>
                    </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                  <button type="submit" class="btn btn-info btn-primary">Guardar Cajero</button>
              </div>
              </form>
          </div>
      </div>
