...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Pre Compras Estudiantes <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Pre Compras Estudiantes <span class="fw-300"><i>Pendientes Entrega</i></span>
                  </h2>
