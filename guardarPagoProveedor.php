...
<tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalPago1">Pago</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalPago1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Pago Proveedor Cafeteri.sa                <small>Identificaci&oacute;n1714764220001</small>
                </h4>
            ...
            <div class="modal-body">
              <form method="get" action="guardarPagoProveedor.php">
                  ...
                  <input name="proceso" type="hidden" id="proceso" value="21602840784" />
...
<tr>
                                  ...
                                  <td>Corpsunrise</td>
                                  <td align="center"><button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modalPago2">Pago</button></td>
                              </tr><!-- Modal -->
<div class="modal fade" id="modalPago2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Pago Proveedor Productos Propios Cocina                <small>Identificaci&oacute;n1714764220</small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
