...
?>
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Nuevo Estudiante <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Registro <span class="fw-300"><i>Estudiante</i></span>
                  </h2>
...
?>
                      ...
                      <div class="form-group">
                          <label class="form-label" for="simpleinput">Codigo Estudiante</label>
                          <input type="text" name="codigoEstudiante" id="simpleinput" class="form-control" placeholder="Digite codigo estudiante" required>
                      </div>

                      <?php echo isset($_SESSION['errores']) ? mostrar_error($_SESSION['errores'], 'estudiante') : ''; ?> 

                      <div class="form-group">
                          <label class="form-label" for="simpleinput">Apellidos</label>
                          <input type="text" name="apellidosEstudiante" id="simpleinput" class="form-control" placeholder="Digite apellidos" required>
                      </div>

                      <div class="form-group">
                          <label class="form-label" for="simpleinput">Nombre</label>
                          <input type="text" name="nombreEstudiante" id="simpleinput" class="form-control" placeholder="Digite nombre" required>
                      </div>

                      <div class="form-group">
                          <label class="form-label" for="example-select">Sexo</label>
                          <select class="form-control" name="sexo" id="example-select" required>
                      ...
                      <div class="form-group">
                          <label class="form-label" for="example-select">Grado</label>
                          <select class="form-control" name="grado" id="example-select" required>
                              <option value="">Seleccione</option>
<?php
...
?>
                      ...
                      <button type="submit" class="btn btn-info btn-primary">Guardar Estudiante</button>
                      </div>
                      </form>
                      <?php borrar_error();?>
                  </div>
