...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Informe Entrega Planes Alimentaci&oacute;n <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Entrega Planes Alimentaci&oacute;n  <span class="fw-300"><i>Periodo</i></span>
                  </h2>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
                    <form method="get" action="entregaPlanesFecha.php">
                      ...
                      <button type="submit" class="btn btn-info btn-primary">Ver Entregas</button>
                      </div>
                    </form>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Entregas Planes Alimentaci&oacute;n <span class="fw-300"><i>Hoy</i></span>
                  </h2>
