...
<i class="ni ni-chevron-down hidden-xs-down"></i> -->
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Subir Menu</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Subir Menu <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              ...
              <div class="panel-container show">
                  ...
                  <form method="post" enctype="multipart/form-data" action="subirMenu.php">
                    <div class="panel-tag">
                    ...
                    <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-info btn-primary">Subir Menu</button>
                      </form>
                    </div>
                  </div>
              </div>
  ...
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Menu <span class="fw-300"><i>Actual</i></span>
                  </h2>
                  <div class="panel-toolbar">
                    <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Pantalla Completa"></button>
               </div>
              ...
              <div class="panel-container show">
                  <div class="panel-content">
<center><img src="/admin/archivos/ALMUERZOS - MENU MARZO 2020 SS.jpg" width="990" height="auto"></center>
                  </div>
              </div>
          </div>
      </div>
