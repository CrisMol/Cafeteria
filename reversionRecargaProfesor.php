...
?>
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Recarga Profesor</li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Reversiones Recarga Profesor <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  ...
  <div class="row">
      <div class="col-xl-12">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Recargas Profesor <span class="fw-300"><i>Hoy</i></span>
                  </h2>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Reversar Recarga ID#<?=$recarga['CODIGO_RECARGA']?> 
                    <small>Profesor: <?=$recarga['NOMBRE_CLIENTE']?></small>                 
                </h4>
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="reversarRecargaProfesor.php">

                    <div class="form-group">
                      <label class="form-label" for="simpleinput">Fecha</label>
                      <input name="fechaMovimiento" type="text" id="simpleinput" value="<?=$recarga['FECHA']?>" class="form-control"  disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Hora</label>
                      <input type="text" id="simpleinput" value="<?=$recarga['HORA']?>" class="form-control" name="horaMovimiento" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor</label>
                      <input type="text" id="simpleinput" value="<?=$recarga['VALOR']?>" class="form-control" name="CreditoMovimiento" disabled>
                  </div>

            </div>
            <div class="modal-footer">
              <input name="valor" type="hidden" id="valor" value="<?=$recarga['VALOR']?>" />
              <input name="fecha" type="hidden" id="valor" value="<?=$recarga['FECHA']?>" />
              <input name="hora" type="hidden" id="valor" value="<?=$recarga['HORA']?>" />
              <input name="codigoRecarga" type="hidden" id="idExtracto" value="<?=$recarga['CODIGO_RECARGA']?>" />
              <input name="idProfesor" type="hidden" id="idProfesor" value="<?=$recarga['CODIGO_CLIENTE']?>" />
...
<?php echo isset($_SESSION['errores']) ? mostrar_error($_SESSION['errores'], 'codigoRecarga') : ''; ?>
 <?php echo isset($_SESSION['errores']) ? mostrar_error($_SESSION['errores'], 'idProfesor') : ''; ?>
<?php borrar_error();?>                        </tbody>
                          <tfoot>
                              <tr>
                                <th>ID</th>
                                <th># Recarga</th>
