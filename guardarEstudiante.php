...
if(isset($_POST)){
	...
	if($existe_usuario > 0){
		...
		if (count($errores) == 0) {
			$sql = "INSERT INTO estudiante(`ID_ESTU`, `ID_FAM`, `ID_GRADO`, `APELLIDO_ESTU`, `NOM_ESTU`, `SEXO_ESTU`) ".   "VALUES ('$codigoEstudiante','$codigoFamilia',$grado,'$apellidosEstudiante','$nombreEstudiante','$sexo');";
