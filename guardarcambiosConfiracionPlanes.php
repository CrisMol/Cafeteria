    ...
    <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
        <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
            <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                <span class="mr-2">
                    <img src="img/logocafeterisapng.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                </span>
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-home'></i> Configuraci&oacute;n Planes Alimentaci&oacute;n <span class='fw-300'>Dashboard</span>
        </h1>
  </div>
  <div class="row">
      <div class="col-xl-6">
          <div id="panel-1" class="panel">
              <div class="panel-hdr">
                  <h2>
                      Parametrizaci&oacute;n <span class="fw-300"></span>
                  </h2>
              ...
              <div class="panel-container show">
                  ...
                  <form method="get" action="guardarcambiosConfiracionPlanes.php">

                    <div class="form-group">
                        <label class="form-label" for="example-time-2">Hora Inicio Desayunos</label>
                        <input class="form-control" id="example-time-2" type="time" name="inicioDesayunos" value="07:00:00">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="example-time-2">Hora Fin Desayunos</label>
                        <input class="form-control" id="example-time-2" type="time" name="finDesayunos" value="10:00:00">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="example-select">Producto Venta Desayuno (Estudiante sin Plan Alimentaci&oacute;n)</label>
                        <select class="form-control" id="example-select" name="idProducto1">

<option value="">Seleccione Producto</option><option value="2">Almuerzo Completo - $2.75</option><option value="19">Bebida 10 Oz - $0.50</option><option value="20">Bebida 16 Oz - $0.75</option><option value="17">Bebida 5,5 Oz - $0.25</option><option value="18">Bebida 7 Oz - $0.35</option><option value="22">Bebida Botella 500ml - $0.50</option><option value="21">Bebida Caliente / Aromatica - $0.50</option><option value="13">Desayuno Americano - $2.75</option><option value="11">Desayuno Completo - $2.50</option><option value="12">Desayuno Costeño - $2.50</option><option value="16">Desayuno Light - $2.50</option><option value="14">Desayuno Pancakes - $2.75</option><option value="10">Desayuno Sencillo - $1.75</option><option value="5">Jugo Adicional - $0.25</option><option value="9">Lunch Completo Del Dia - $2.00</option><option value="7">Lunch Completo Especialidad - $2.50</option><option value="8">Lunch Del Dia - $1.75</option><option value="24">Pastel De Cumpleaños Entero - $6.00</option><option value="6">Postre Adicional - $0.25</option><option value="3">Proteina Adicional - $1.00</option><option value="4">Sopa - $1.00</option>                        </select>
                    </div>


                    <div class="form-group">
                        <label class="form-label" for="example-time-2">Hora Inicio Almuerzos</label>
                        <input class="form-control" id="example-time-2" type="time" name="inicioAlmuerzos" value="">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="example-time-2">Hora Fin Almuerzos</label>
                        <input class="form-control" id="example-time-2" type="time" name="finAlmuerzos" value="14:00:00">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="example-select">Producto Venta Almuerzo (Estudiante sin Plan Alimentaci&oacute;n)</label>
                        <select class="form-control" id="example-select" name="idProducto2">

<option value="">Seleccione Producto</option><option value="2">Almuerzo Completo - $2.75</option><option value="19">Bebida 10 Oz - $0.50</option><option value="20">Bebida 16 Oz - $0.75</option><option value="17">Bebida 5,5 Oz - $0.25</option><option value="18">Bebida 7 Oz - $0.35</option><option value="22">Bebida Botella 500ml - $0.50</option><option value="21">Bebida Caliente / Aromatica - $0.50</option><option value="13">Desayuno Americano - $2.75</option><option value="11">Desayuno Completo - $2.50</option><option value="12">Desayuno Costeño - $2.50</option><option value="16">Desayuno Light - $2.50</option><option value="14">Desayuno Pancakes - $2.75</option><option value="10">Desayuno Sencillo - $1.75</option><option value="5">Jugo Adicional - $0.25</option><option value="9">Lunch Completo Del Dia - $2.00</option><option value="7">Lunch Completo Especialidad - $2.50</option><option value="8">Lunch Del Dia - $1.75</option><option value="24">Pastel De Cumpleaños Entero - $6.00</option><option value="6">Postre Adicional - $0.25</option><option value="3">Proteina Adicional - $1.00</option><option value="4">Sopa - $1.00</option>
                        </select>
                    </div>
