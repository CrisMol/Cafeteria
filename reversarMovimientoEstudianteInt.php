                  ...
                  <div class="panel-content">
                      <form>
                          <div class="form-group">
                              ...
                              <input type="text" id="simpleinput" value="1004" class="form-control" disabled>
                          </div>

                          <div class="form-group">
                              <label class="form-label" for="simpleinput">Apellidos</label>
                              <input type="text" id="simpleinput" value="Alban Laines" class="form-control" disabled>
                          </div>

                          <div class="form-group">
                              <label class="form-label" for="simpleinput">Nombre</label>
                              <input type="text" id="simpleinput" value="Darla" class="form-control" disabled>
                          </div>

                          <div class="form-group">
                              <label class="form-label" for="simpleinput">Maximo Compras D&iacute;a</label>
                              <input type="text" id="simpleinput" value="Ilimitado" class="form-control" disabled>
                          </div>
                      ...
                      <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                          ...
                          <tbody>
                            <tr>
                                  ...
                                  <td align="center"><button type="button" class="btn btn-xs btn-outline-info" data-toggle="modal" data-target="#reversarMov3">Rerversar</button></td></tr><!-- Modal -->
<div class="modal fade" id="reversarMov3" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
              ...
              <form method="get" action="reversarMovimientoEstudianteInt.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="simpleinput" name="apellidosEstudiante" value="2020-10-04" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Hora</label>
                      <input type="text" id="simpleinput" name="nombreEstudiante" value="19:46:10" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Descripcion</label>
                      <input type="text" id="simpleinput" name="nombreEstudiante" value="Proteina Adicional" class="form-control" disabled>
                  </div>

                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Valor</label>
                      <input type="text" id="simpleinput" name="nombreEstudiante" value="1.00" class="form-control" disabled>
                  </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="get" action="reversarMovimientoEstudianteInt.php">
                  ...
                  <div class="form-group">
                      <label class="form-label" for="simpleinput">Hora</label>
                      <input type="text" id="simpleinput" name="nombreEstudiante" value="17:59:48" class="form-control" disabled>
                  </div>
